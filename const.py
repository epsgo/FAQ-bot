...
TEXTS = {
    "ru": {
        ...
        "meet_declined_with_datetime": "❌ <b>{name}</b> отклонил ваш запрос на встречу 1:1.\n\n🕐 Дата и время: <b>{datetime}</b>",
        "meet_you_confirmed": "✅ Вы приняли запрос на встречу.",
        "meet_you_declined": "❌ Вы отклонили запрос на встречу.",
        "meet_back": "⬅️ Назад",
        "meet_ask_datetime": "📅 Введите дату и время встречи в формате ДД.ММ.ГГГГ ЧЧ:ММ\n\nНапример: 20.04.2026 14:30\n\nИли нажмите кнопку ниже, чтобы пропустить.",
        "meet_datetime_set": "✅ Дата и время встречи установлены: {datetime}\n\n📬 Мы уведомим вас, когда получатель примет или отклонит запрос.",
        "meet_with_datetime": "📅 <b>{name}</b> хочет провести встречу 1:1 с вами.\n\n🕐 Дата и время: <b>{datetime}</b>",
        "meet_confirmed_with_datetime": "✅ <b>{name}</b> принял ваш запрос на встречу 1:1!\n\n🕐 Дата и время: <b>{datetime}</b>",
        "meet_reminder": "⏰ Напоминание о встрече!\n\n👤 Встреча с: <b>{name}</b>\n🕐 Время: <b>{datetime}</b>",
        "meet_skip_datetime": "⏭ Пропустить (без даты/времени)",
        "meet_invalid_datetime": "❌ Неверный формат даты/времени. Используйте формат: ДД.ММ.ГГГГ ЧЧ:ММ\n\nНапример: 20.04.2026 14:30",
    ...
    "ua": {
        ...
        "meet_declined_with_datetime": "❌ <b>{name}</b> відхилив ваш запит на зустріч 1:1.\n\n🕐 Дата та час: <b>{datetime}</b>",
        "meet_you_confirmed": "✅ Ви прийняли запит на зустріч.",
        "meet_you_declined": "❌ Ви відхилили запит на зустріч.",
        "meet_back": "⬅️ Назад",
        "meet_ask_datetime": "📅 Введіть дату та час зустрічі у форматі ДД.ММ.РРРР ГГ:ХХ\n\nНаприклад: 20.04.2026 14:30\n\nАбо натисніть кнопку нижче, щоб пропустити.",
        "meet_datetime_set": "✅ Дату та час зустрічі встановлено: {datetime}\n\n📬 Ми повідомимо вас, коли отримувач прийме або відхилить запит.",
        "meet_with_datetime": "📅 <b>{name}</b> хоче провести зустріч 1:1 з вами.\n\n🕐 Дата та час: <b>{datetime}</b>",
        "meet_confirmed_with_datetime": "✅ <b>{name}</b> прийняв ваш запит на зустріч 1:1!\n\n🕐 Дата та час: <b>{datetime}</b>",
        "meet_reminder": "⏰ Нагадування про зустріч!\n\n👤 Зустріч з: <b>{name}</b>\n🕐 Час: <b>{datetime}</b>",
        "meet_skip_datetime": "⏭ Пропустити (без дати/часу)",
        "meet_invalid_datetime": "❌ Невірний формат дати/часу. Використовуйте формат: ДД.ММ.РРРР ГГ:ХХ\n\nНаприклад: 20.04.2026 14:30",
        "goodbye": "Гарного дня! 😊",
    },
    "en": {
        ...
        "meet_declined_with_datetime": "❌ <b>{name}</b> declined your 1:1 meeting request.\n\n🕐 Date and time: <b>{datetime}</b>",
        "meet_you_confirmed": "✅ You confirmed the meeting request.",
        "meet_you_declined": "❌ You declined the meeting request.",
        "meet_back": "⬅️ Back",
        "meet_ask_datetime": "📅 Enter meeting date and time in format DD.MM.YYYY HH:MM\n\nFor example: 20.04.2026 14:30\n\nOr press the button below to skip.",
        "meet_datetime_set": "✅ Meeting date and time set: {datetime}\n\n📬 We will notify you when the recipient accepts or declines the request.",
        "meet_with_datetime": "📅 <b>{name}</b> wants to have a 1:1 meeting with you.\n\n🕐 Date and time: <b>{datetime}</b>",
        "meet_confirmed_with_datetime": "✅ <b>{name}</b> confirmed your 1:1 meeting request!\n\n🕐 Date and time: <b>{datetime}</b>",
        "meet_reminder": "⏰ Meeting reminder!\n\n👤 Meeting with: <b>{name}</b>\n🕐 Time: <b>{datetime}</b>",
        "meet_skip_datetime": "⏭ Skip (no date/time)",
        "meet_invalid_datetime": "❌ Invalid date/time format. Use format: DD.MM.YYYY HH:MM\n\nFor example: 20.04.2026 14:30",
